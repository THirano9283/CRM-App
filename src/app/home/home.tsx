        ...
        <div className={classes("row-layout group")}>
          <div className={classes("column-layout group_1")}>
            ...
            <div className={classes("column-layout group_4")}>
              ...
              <IgrGrid data={northwindCustomers} primaryKey="customerID" rowSelection="single" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")}>
